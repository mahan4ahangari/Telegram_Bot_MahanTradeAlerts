...
# TIME_FORMAT = "%Y-%m-%d %H:%M:%S"  # فرمت ذخیره زمان

# # 📂 خواندن لیست کاربران از فایل
...
#     unit = duration_str[-1].lower()  # آخرین حرف m,h,d
...
#     if not user_data:
#         await update.message.reply_text("اشتراک رو شارژ کن")
#         return
...
#     if now > expire_time:
#         await update.message.reply_text("اشتراکت تموم شد")
#         return

#     message = (
#         "سلام به ربات تحلیل و سیگنال خوش آمدید.\n"
#         "لطفا منتظر بمانید، سیگنال ها برای شما تا روزی ۳ عدد ارسال میگردد.\n"
#         "در صورت دریافت سیگنال های بیشتر به پیوی زیر مراجعه کنید.\n"
#         "@Buooum"
#     )
#     await update.message.reply_text(message)

# # ➕ دستور ادمین برای اضافه کردن کاربر با زمان مشخص
...
# # ➕ دستور ادمین /adduser با پیام اطلاع‌رسانی
# async def add_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
#             chat_id=new_id,
#             text=f"🎉 سلام! اشتراک شما در ربات تا {expire_time} فعال شد."
#         )
#     except:
#         # اگر کاربر بلاک کرده یا مشکلی داشت، نادیده گرفته شود
#         pass
